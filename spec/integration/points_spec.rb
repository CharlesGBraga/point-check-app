  ...
  path '/points' do
    get 'List points' do
      ...
      parameter name: 'q[user_id_eq]', in: :query, type: :integer, description: 'Search by user id', required: false,
                example: 1
      parameter name: 'q[created_at_gteq]', in: :query, type: :string, description: 'Search created at from', required: false,
                example: '2022-12-16'
      parameter name: 'q[created_at_lteq]', in: :query, type: :string, description: 'Search created at until', required: false,
                example: '2022-12-16'
